...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      locale: ogLocale,
      url: `https://marimbashome.com/blog/${locale}/blog`,
    },
    twitter: {
      card: 'summary',
      title: tr('meta_title'),
    ...
    alternates: {
      canonical: `https://marimbashome.com/blog/${locale}/blog`,
      languages: {
        es: 'https://marimbashome.com/blog/es/blog',
        en: 'https://marimbashome.com/blog/en/blog',
      },
    },
  };
}
